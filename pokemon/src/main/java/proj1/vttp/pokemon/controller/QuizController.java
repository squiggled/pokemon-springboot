...
public class QuizController {
    ...
    @GetMapping("/quiz")
    public String quiz(Model model, HttpSession session, RedirectAttributes redirectAttributes) {
        Optional<Question> optionalQuestion = quizAPIService.getQuestion();
    ...
    @PostMapping("/quiz")
    public String verifyAns(@RequestBody MultiValueMap<String, String> form, Model model, HttpSession session,
